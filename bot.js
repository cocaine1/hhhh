...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = [' -help',`Im on ${client.guilds.size} servers`,`i help ${client.users.size} Members`,' by cocaine  ','3mk_COCAINE'];
    var i = -1;
    var j = 0;
...
client.login("NjE4NzIwMjQxNTIyMDQ5MDI0.XW9yKA.eVjoCg6DsNnlq7X_ZwhMI11qF2Q");
